...
# -*- coding: utf-8 -*-
"""
ROM Sorter Pro - Theme-Einstellungen

Dieses Modul definiert die Standard-Themes und Pfade für benutzerdefinierte Themes.
"""
...
def get_theme_path():
    """
    Gibt den Pfad zum Theme-Verzeichnis zurück und erstellt es bei Bedarf

    Returns:
        Path: Pfad zum Theme-Verzeichnis
    """
...
def get_default_theme_settings(theme_name="system"):
    """
    Gibt die Standard-Theme-Einstellungen für ein bestimmtes Theme zurück

    Args:
        theme_name: Name des Themes ('light', 'dark' oder 'system')

    Returns:
        dict: Theme-Einstellungen
    """
