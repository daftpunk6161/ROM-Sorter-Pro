...
class BaseApp:
    ...
    def create_basic_window(self, title: str, geometry: str = "800x600") -> tk.Tk:
        """Creates A Basic Interter Window. Args: Title: Title of the Window Geometry: Size of the Window in the "Breitexhöhe" Format Return: TK.TK: The Created Tkinter Window"""
        root = tk.Tk()
        root.title(title)
