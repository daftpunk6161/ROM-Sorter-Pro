...
class ThemeFonts:
    """Schriftarten für die Anwendung."""
...
class UIStyle:
    """Zentraler Style-Manager für die Anwendung."""

    def __init__(self):
        """Initialisiere den Style-Manager mit Standardwerten."""
...
# Beam
    ...
    def apply_to_widget(self, widget: tk.Widget, widget_type: str = 'frame') -> None:
        """
        Wendet den Stil auf ein bestimmtes Widget an.

        Args:
            widget: Das Widget, auf das der Stil angewendet werden soll
            widget_type: Der Typ des Widgets (frame, button, label, etc.)
        """
...
class BaseApp:
    """Basisklasse für die Anwendung mit grundlegenden Funktionen."""

    def __init__(self):
        """Initialisiere die Basisanwendung."""
    ...
    def get_asset_path(self, asset_name: str) -> Path:
        ...
        Args:
            asset_name: Name der Asset-Datei

        Returns:
            Path: Der absolute Pfad zur Asset-Datei
        """
        return self.assets_dir / asset_name

    def create_basic_window(self, title: str, geometry: str = "800x600") -> tk.Tk:
        """
        Erstellt ein grundlegendes Tkinter-Fenster.

        Args:
            title: Titel des Fensters
            geometry: Größe des Fensters im Format "BreitexHöhe"

        Returns:
            tk.Tk: Das erstellte Tkinter-Fenster
        """
        root = tk.Tk()
        root.title(title)
...
def create_tooltip(widget: tk.Widget, text: str) -> None:
    ...
    def show_tooltip(event=None):
        """Zeigt den Tooltip an der Mausposition an."""
