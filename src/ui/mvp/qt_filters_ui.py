...
def build_filters_ui(QtWidgets, QtCore, QtGui) -> Tuple[Any, FilterWidgets]:
    ...
    lang_filter.setToolTip("Sprachen filtern (Mehrfachauswahl)")
    ...
    console_filter.setToolTip("Konsolen filtern (Mehrfachauswahl)")

    ver_filter = QtWidgets.QComboBox()
    ver_filter.addItems(["All"])
    ver_filter.setMinimumWidth(200)
    ver_filter.setToolTip("Versionen filtern")
