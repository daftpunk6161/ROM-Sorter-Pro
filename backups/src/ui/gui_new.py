#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Rome Sarter Pro - Main Module V2.1.8 (Compatibility Layer) This is a Compatibility Wrapper Around the Main Gui Modules. It redirects to the standard gui implementation to avoid duplication."""
